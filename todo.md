...
[ ] - Добавить компонент BlueLink
[ ] - Заменить кнопку AddButton на BlueLink в ResourceTable
[ ] - Переписать Links в ResourceTable на BlueLink
...
[ ] - Добавить очистку приглашений
[ ] - Проверить, что бы в моделях были настройки, ограничения, методы и связи
[ ] - Проверить flsh ответы
[ ] - Заменить использование $request->input() валидируемых данных на $request->validated()
